...
* サポートツール {#support-tools}
   ...
   * QPT ツール {#patches} で使用可能なパッチ
      ...
      * v1.1.26 {#v1-1-26}
         ...
         * [ACSD-48587:HTML文字を含む SKU で Product ウィジェットが機能しない](/help/support-tools/patches-available-in-qpt-tool/v1-1-26/acsd-48587-product-widget-not-working-with-html-characters.md)
      ...
      * v1.1.33{#v1-1-33}
         ...
         * [ACSD-51120:GraphQL GET リクエストのキャッシュが、CMS ブロックを含んだCMS ページでクリアされない](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51120-graphql-get-requests-cache-not-cleared-for-cms-pages.md)
