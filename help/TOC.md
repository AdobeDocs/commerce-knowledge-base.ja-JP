...
* サポートツール {#support-tools}
   ...
   * QPT ツールで使用可能なパッチ {#patches}
      ...
      * v1.1.23 {#v1-1-23}
         ...
         * [ACSD-46519:product_count in [!UICONTROL categoryList] [!DNL GraphQL] クエリを実行すると、アンカーカテゴリに対して 0 が返される](/help/support-tools/patches-available-in-qpt-tool/v1-1-23/acsd-46519-product-count-categorylist-graphql-query-returns-zero-anchor-categories.md)
      ...
      * v1.1.24 {#v1-1-24}
         ...
         * [ACSD-47920：ゲストユーザーは、次の場合でも、REST API を使用して注文できます [!UICONTROL Allow Guest Checkout] オフ](/help/support-tools/patches-available-in-qpt-tool/v1-1-24/acsd-47920-guest-order-allow-guest-checkout-off.md)
         ...
         * [ACSD-46770：次の場合でも注文確認メールが送信されます [!UICONTROL Email order confirmation] オフ](/help/support-tools/patches-available-in-qpt-tool/v1-1-24/acsd-46770-an-order-confirmation-email-is-sent-even-when-the-email-order-confirmation-is-unchecked.md)
         * [ACSD-47336: [!UICONTROL Something went wrong] エラー通知が破棄されました：Adobe Commerce管理者](/help/support-tools/patches-available-in-qpt-tool/v1-1-24/acsd-47336-something-went-wrong-error-when-dismissing-notifications-adobe-commerce-admin.md)
      ...
      * v1.1.25 {#v1-1-25}
         ...
         * [ACSD-48234：次の場合、カタログ検索結果に誤ったカテゴリ項目数が表示される [!UICONTROL Display Out of Stock Products] enabled](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48234-catalog-search-result-shows-incorrect-category-item-count-when-show-out-of-stock-option-enabled.md)
         ...
         * [ACSD-48313: [!UICONTROL configurable_variations] 属性値にコンマが含まれる場合、列は解析されません](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48313-configurable-variations-column-not-parsed-attribute-value-contains-comma.md)
      ...
      * V1.1.27 {#v1-1-27}
         ...
         * [ACSD-48634: [!DNL JS] エラー条件 [!DNL Google Analytics Content Experiments] enabled](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-48634-js-errors-when-google-analytics-content-experiments-enabled.md)
      ...
      * v1.1.28 {#v1-1-28}
         ...
         * [ACSD-48857：で変更を保存できない [!DNL Page Builder]](/help/support-tools/patches-available-in-qpt-tool/v1-1-28/acsd-48857-unable-to-save-changes-after-editing-with-pagebuilder.md)
      ...
      * v1.1.29 {#v1-1-29}
         ...
         * [ACSD-49835: [!UICONTROL Use Default Value] チェックボックスが保存されていません](/help/support-tools/patches-available-in-qpt-tool/v1-1-29/acsd-49835-use-default-value-chekbox-not-saved.md)
         ...
         * [ACSD-49502：の後、ダウンロード可能なリンクが正しく更新されない [!DNL staging] 更新](/help/support-tools/patches-available-in-qpt-tool/v1-1-29/acsd-49502-downloadable-link-not-updated-correctly.md)
      ...
      * v1.1.30 {#v1-1-30}
         ...
         * [ACSD-49973：を介したバンドル製品の取得パフォーマンスの向上 [!DNL GraphQL]](/help/support-tools/patches-available-in-qpt-tool/v1-1-30/acsd-49973-improved-performance-fetching-bundled-products-via-graphql.md)
      ...
      * v1.1.32 {#v1-1-32}
         ...
         * [ACSD-51379：を使用したページのテキストコンテンツの変更 [!DNL Page Builder] は保存されませんでした](/help/support-tools/patches-available-in-qpt-tool/v1-1-32/acsd-51379-changes-made-to-page-text-content-via-page-builder-are-not-saved.md)
         ...
         * [ACSD-51294：価格、数量、税、送料、文字列としてに送信された売上高 [!DNL Google Analytics] および GTM](/help/support-tools/patches-available-in-qpt-tool/v1-1-32/acsd-51294-price-quantity-tax-shipping-and-revenue-are-sent-as-string-to-google-analytics-and-gtm.md)
      ...
      * v1.1.33 {#v1-1-33}
         ...
         * [ACSD-51120:GraphQL GETリクエストで、CMS ブロックを含む CMS ページのキャッシュがクリアされない](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51120-graphql-get-requests-cache-not-cleared-for-cms-pages.md)
         ...
         * [ACSD-51735：注文項目のステータスが正しくに設定されていません [!UICONTROL Ordered] 製品在庫が 0 の場合](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51735-order-item-status-incorrectly-set.md)
      ...
      * v1.1.35{#v1-1-35}
         ...
         * [ACSD-51149: スケジュール型 [!UICONTROL ImportExport] が有効の場合 [!UICONTROL Catalog Permissions] インデクサーを無効にします](/help/support-tools/patches-available-in-qpt-tool/v1-1-35/acsd-51149-scheduled-importexport-enabled-catalog-permissions-invalidates-indexers.md)
         ...
         * [ACSD-52786: カタログルール [!UICONTROL SKU is] sku で始まるすべての製品に適用](/help/support-tools/patches-available-in-qpt-tool/v1-1-35/acsd-52786-catalog-rule-sku-is-applies-to-all-products-starting-with-it.md)
         ...
         * [ACSD-52831：次の場合は交渉可能な見積注文を行えません [!DNL Google reCAPTCHA v3 Invisible] enabled](/help/support-tools/patches-available-in-qpt-tool/v1-1-35/acsd-52831-cannot-place-negotiable-quote-orders.md)
      ...
      * v1.1.36{#v1-1-36}
         ...
         * [ASCD-52736: [!UICONTROL Cart Price Rule] が期待どおりに動作しない](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-52736-cart-price-rule-doesnt-work-as-expected.md)
         * [ACSD-53239：インベントリインデクサーが [!UICONTROL Update on Schedule] モード](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-53239-inventory-indexer-cleans-all-caches.md)
         * [ACSD-50887: [!UICONTROL Use in Search Results Layered Navigation] 「」を除いてはいに設定します [!UICONTROL Use in Search] オプション](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-50887-product-attribute-use-in-search-results-layered-navigation-set-to-yes-without-use-in-search-option.md)
         * [ACSD-51846：内部エラー： [!DNL REST API] ペイロードレベルが検証されない](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-51846-internal-error-as-levels-of-rest-api-payload-are-not-validated.md)
      ...
      * v1.1.37 {#v1-1-37}
         ...
         * [ACSD 49843：で自動請求後、製品のダウンロードリンクを使用できない [!UICONTROL Payment Action] =販売](/help/support-tools/patches-available-in-qpt-tool/v1-1-37/acsd-49843-link-to-product-download-unavailable-after-being-autoinvoiced-with-payment-action-sale.md)
      * v1.1.38 {#v1-1-38}
      ...
      * v1.1.39 {#v1-1-39}
         ...
         * [ACSD-54660：顧客の注文を並べ替える新しい入力属性ソート [!DNL GraphQL]](/help/support-tools/patches-available-in-qpt-tool/v1-1-39/acsd-54660-new-input-attribute-sort-to-sort-customer-orders-in-graphql.md)
      ...
      * v1.1.40 {#v1-1-40}
         ...
         * [ACSD-53414：制限付き管理者ユーザーが、自身の権限範囲外の CMS ページを表示できる](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-53414-restricted-admin-user-can-see-cms-pages-outside-permissions.md)
         ...
         * [ASCD-54040: [!UICONTROL Created] b2B モジュールが有効な場合、注文の詳細のフィールドが空白になる](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54040-created-field-is-blank-in-order-details-page.md)
         ...
         * [ACSD-54319：製品価格が 0 と表示される [!UICONTROL Products in Carts] 報告書](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54319-product-price-shows-zero-in-product-in-cart-report.md)
         * [ACSD-54989：会社管理者は、次の場合に注文できません [!UICONTROL Enable Purchase Orders] 「はい」に設定し、 [!UICONTROL Purchase Order] 「いいえ」に設定](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54989-order-placement-restrictions-in-company-admin-settings.md)
      ...
      * v1.1.41 {#v1-1-41}
         ...
         * [ACSD-54376：商品がから削除された場合に、買い物かごで例外が発生する [!UICONTROL shared catalog]](/help/support-tools/patches-available-in-qpt-tool/v1-1-41/acsd-54376-exception-shopping-cart-product-removed-from-shared-catalog.md)
      ...
      * v1.1.42 {#v1-1-42}
         ...
         * [ACSD-53568: [!UICONTROL Recently Viewed Product] ストア表示のデータが正しく更新されていません](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-53658-fixes-the-issue-where-recently-viewed-product-data-is-not-updated-in-the-store-view.md)
         ...
         * [ACSD-55112: [!UICONTROL Submit Review] ボタンは複数回クリックできます](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-55112-submit-review-button-can-be-clicked-multiple-times.md)
         ...
         * [ACSD-54890:aggregate_sales_report_bestsellers_data の原因 [!DNL MySQL] エラー](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-54890-aggregate-sales-report-bestsellers-data-causes-mysql-errors.md)
      ...
      * v1.1.43 {#v1-1-43}
         ...
         * [ACSD-55305：での会社ユーザーの編集中にポップアップがフリーズする [!UICONTROL My Account]](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-55305-freeze-issue-in-company-user-edit-popup.md)
         ...
         * [ACSD-53636：通常価格が表示されない [!UICONTROL Product Listing] ページ](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-53636-regular-price-is-not-displayed-on-product-listing-page.md)
         * [ACSD-53925：を使用して CMS ブロックを保存できない [!UICONTROL Product Carousel]](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-53925-cant-save-cms-block-with-product-carousel-catalog-product-price-dimensions-set-to-website.md)
         ...
         * [ACSD-53309：カスタマイズ可能なオプションおよび「」の不完全な税金適用[!UICONTROL Regular Price]ラベル](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-53309-incomplete-tax-application-for-customizable-options.md)
         ...
         * [ACSD-54739: [!UICONTROL Product Stock] ステータスが適用されていません [!UICONTROL Related Product Rules]](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-54739-product-stock-status-not-applied-for-related-product-rules.md)
         * [ACSD-54983：非アクティブなユーザーで、GraphQLを含む会社のユーザー UID を使用できない](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-54983-company-user-uid-with-graphql-not-available-with-inactive-user.md)
      * v1.1.44 {#v1-1-44}
         ...
         * [ACSD-55352：作成 [!UICONTROL Credit Memo] 報酬ポイントで](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-55352-creating-credit-memos-with-reward-points.md)
         ...
         * [ACSD-56193: [!DNL Fastly/Varnish] コンテンツのステージング更新でキャッシュがクリアされない](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56193-fastly-cache-not-cleared-for-content-staging-update.md)
         ...
         * [ACSD-56023：ウィジェットのコンテンツが CMS ページで更新されない](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56023-widget-content-not-updating-on-the-cms-page.md)
      ...
      * v1.1.45 {#v1-1-45}
         ...
         * [ACSD-54965: [!UICONTROL Visual Merchandising] グリッドに正しい素材が表示されない](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-54965-visual-merchandising-grid-not-display-correct-stock.md)
         ...
         * [ACSD-56515：権限を持つ管理者は編集できない [!UICONTROL Dynamic Block]](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-56515-admin-with-permissions-cannot-edit-dynamic-block.md)
         ...
         * [ASCD-56415：のパフォーマンス [!UICONTROL Partial Price Indexing] クエリのDELETEにより速度が低下しています](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-56415-performance-of-partial-price-indexing-is-slowed-down-due-to-a-delete-query.md)
      * v1.1.46 {#v1-1-46}
         * [概要： [!DNL Quality Patches Tool] （QPT） v1.1.46](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/overview.md)
         * [ACSD-46767: [!UICONTROL Category] 在庫数が変更されると、ページキャッシュが無効になります](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-46767-category-page-caches-invalidate-when-the-stock-quantity-changes.md)
         * [ACSD-54656：非表示 [!DNL reCAPTCHA] チェックアウト時に失敗し、注文が行われなくなる](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-54656-invisible-recaptcha-fails-during-checkout-preventing-order-placement.md)
...
* トラブルシューティング {#troubleshooting}
   ...
   * データベース {#database}
      ...
      * [Adobe Commerce データベースの数値が範囲外です。 [!DNL INT] 対象： [!DNL BIGINT]](/help/troubleshooting/database/int-biginit-schema-update-request.md)
   ...
   * 支払額 {#payments}
      * [での注文ページ作成のトラブルシューティング [!UICONTROL CSP] 制限付きモード](/help/troubleshooting/payments/admin-create-order-page-in-csp-restricted-mode.md)
      * [のストアフロントチェックアウトページのトラブルシューティング [!UICONTROL CSP] 制限付きモード](/help/troubleshooting/payments/storefront-checkout-page-in-csp-restricted-mode.md)
   ...
   * インストールとアップグレード {#installation-and-upgrade}
      ...
      * [[!DNL B2B] Adobe Commerce 2.4.6-p1 オンプレミスで 1.4.0 のインストールが失敗する](/help/troubleshooting/installation-and-upgrade/b2b-1-4-0-installation-fails-on-adobe-commerce-2-4-6-p1-on-premises.md)
   ...
   * その他 {#miscellaneous}
      ...
      * [Redis のシリアル化解除エラー設定:static-content:deploy](/help/troubleshooting/miscellaneous/redis-unserialize-error-setup-static-content-deploy.md)
      ...
      * [セットアップの実行:static-content:deploy_version.txt の問題](/help/troubleshooting/miscellaneous/run-setup-static-content-deploy-deployed-version-txt-issue.md)
      ...
      * [[!DNL SendGrid] Adobe Commerce Cloudのファイル制限](/help/troubleshooting/miscellaneous/sendgrid-file-limitation.md)
   * デプロイメント {#deployment}
