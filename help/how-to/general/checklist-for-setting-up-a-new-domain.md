...
>[!NOTE]
>
>ユーザーガイドの [!DNL domain][!DNL Fastly] に [!DNL Admin] すように、**[!UICONTROL Stores]**/**[!UICONTROL Configuration]**/**[!UICONTROL Advanced]**/**[!UICONTROL System]**/**[!UICONTROL Full Page Cache]**/**[!DNL Fastly Configuration]**/**[!UICONTROL Domains]** の [[!DNL Manage domains] で設定を更新することで、新しい ](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/cdn/setup-fastly/fastly-custom-cache-configuration.html?lang=ja#manage-domains) を自分に追加できます。
>
