...
description: '[ 管理者ユーザー ] （https://experienceleague.adobe.com/en/docs/commerce-business-intelligence/mbi/administrator/user-mgmt/user-management）には、Data Warehouse Manager で特定の計算列を作成および編集する機能があります。 これらの計算列を使用すると、ビジネス上の主要な質問に回答するために探しているレポートを設定できます。'
...
[ 管理者ユーザー ](https://experienceleague.adobe.com/en/docs/commerce-business-intelligence/mbi/administrator/user-mgmt/user-management) は、Data Warehouse Manager で特定の計算列を作成および編集できます。 これらの計算列を使用すると、ビジネス上の主要な質問に回答するために探しているレポートを設定できます。

Data Warehouse Manager で作成できる計算列のリストと、正しく設定されていることを確認するためのガイダンスについては、アドビのユーザーガイドの次の記事を参照してください。
...
通常の計算列の作成に関するヘルプが必要な場合や、高度な計算列を作成または編集する場合は [ チームに問い合わせて ](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket)、次を含めてください。
