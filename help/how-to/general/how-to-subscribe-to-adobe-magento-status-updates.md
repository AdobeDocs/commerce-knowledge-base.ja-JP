...
description: この記事では、[Adobeステータス ] （https://status.adobe.com/ja-jp）でAdobe Commerce ステータスを登録して、ステータスアラート、アップデート、大規模な停止やメンテナンスに関する情報を確認する方法について説明します。
...
1. [Adobeの状態 &#x200B;](https://status.adobe.com/ja-jp) に移動します。
1. **ログイン** をクリックします。
