...
MDVA-36253 パッチは、複数配送のチェックアウトステップを使用する際に、商品を削除した後にミニ買い物かごページに戻ると、商品価格が更新されない問題を解決します。 このパッチは、 [品質向上パッチツール（QPT）](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.0.22 がインストールされています。 パッチ ID は MDVA-36253。 この問題はAdobe Commerce 2.4.3 で修正されました。
...
1. 買い物かごに移動して、 **複数のアドレスを使用してチェックアウト**.
1. 1 つの項目を削除します。
1. ホームページに戻ります。
