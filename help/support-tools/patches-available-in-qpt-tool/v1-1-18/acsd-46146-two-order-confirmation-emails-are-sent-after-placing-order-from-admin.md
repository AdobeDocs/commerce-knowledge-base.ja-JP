...
ACSD-46146 パッチを使用すると、管理者から注文を行った後に 2 通の注文確認メールが送信される問題を解決できます。 このパッチは、 [品質向上パッチツール（QPT）](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.18 がインストールされています。 パッチ ID は ACSD-46146 です。 この問題はAdobe Commerce 2.4.6 で修正される予定であることに注意してください。
...
1. Commerce管理者を開きます **売上** > **注文件数** > **新しい注文を作成**.
