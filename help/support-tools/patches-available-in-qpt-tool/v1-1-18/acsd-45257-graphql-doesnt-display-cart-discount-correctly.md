...
ACSD-45257 パッチを適用すると、GraphQLに買い物かごの割引が正しく表示されない問題が修正されます。 このパッチは、 [品質向上パッチツール（QPT）](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.18 がインストールされています。 パッチ ID は ACSD-45257 です。 この問題はAdobe Commerce 2.4.6 で修正される予定であることに注意してください。
...
1. に移動 **Admin** > **Marketing** > **プロモーション** > **買い物かご価格ルール**.
