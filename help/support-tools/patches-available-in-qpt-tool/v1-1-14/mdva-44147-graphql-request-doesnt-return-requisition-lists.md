...
1. 顧客としてログインし、[ 購買依頼リスト ](https://experienceleague.adobe.com/ja/docs/commerce-admin/b2b/requisition-lists/requisition-lists) に製品を追加します。
1. [ 顧客トークン ](https://developer.adobe.com/commerce/webapi/graphql/schema/customer/mutations/generate-token/) を作成します。
