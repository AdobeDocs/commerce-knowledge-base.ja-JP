...
* [Adobe Commerce オンプレミスおよびAdobe Commerce - Magento Open Source アプリケーションおよびモジュールをアップグレードし &#x200B;](https://experienceleague.adobe.com/ja/docs/commerce-operations/upgrade-guide/overview) す。
