...
1. 自己管理サー [&#x200B; スを有効にするには、](https://experienceleague.adobe.com/ja/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket)Adobe Commerce サポート [!DNL crons] にお問い合わせください。
